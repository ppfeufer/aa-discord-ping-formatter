    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name of the Discord role to ping', max_length=255, unique=True)),
                ('discord_id', models.CharField(help_text='ID of the Discord role to ping', max_length=255, unique=True)),
                ...
                ('restricted_to_group', models.ManyToManyField(blank=True, help_text='Restrict the right to ping this Discord group to one or more groups.', related_name='discord_role_require_groups', to='auth.Group')),
            ],
            options={
